        ...
        <div className="grid gap-4 grid-cols-2">
          <div>
            ...
            <table>
              ...
              <button
                type="button"
                className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mt-2"
                onClick={tick}
              >
                Tick
              </button>
